//
//  LBMineCenterUsualUnderOrderTwoViewController.m
//  Universialshare
//
...
@interface LBMineCenterUsualUnderOrderTwoViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation LBMineCenterUsualUnderOrderTwoViewController
...
-(void)initdatasource{
    ...
    [NetworkManager requestPOSTWithURLStr:@"user/order_line" paramDic:@{@"page":[NSNumber numberWithInteger:_page] , @"uid":[UserModel defaultUser].uid , @"token":[UserModel defaultUser].token ,@"type":[NSNumber numberWithInteger:1],@"typeID":OrdinaryUser} finish:^(id responseObject) {
