//
//  GLBuyBackRecord_ApplyController.m
//  PovertyAlleviation
//
...
@interface GLBuyBackRecord_ApplyController()<UITableViewDelegate,UITableViewDataSource>
{
    LoadWaitView *_loadV;
...
@implementation GLBuyBackRecord_ApplyController
